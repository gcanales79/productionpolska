...
module.exports = function(app) {
  ...
  app.post(
    ...
    passport.authenticate("local", {
      failureRedirect: "/",
      badRequestMessage: "Por favor llena la forma",
      failureFlash: true,
    }),
    function(req, res) {
  ...
  app.post("/api/produccion", function(req, res) {
    ...
    if (req.body.shift == 3) {
      db.Polska2.create({
        ...
        WS3a_CellGPF1: req.body.WS3a_CellGPF1,
        WS3a_CellGPF2: req.body.WS3a_CellGPF2,
      ...
      db.Polska2.create({
        ...
        ws3a_cell1: req.body.ws3a_cell1,
        ws3a_cell2: req.body.ws3a_cell2,
        WS3a_CellGPF1: req.body.ws3a_cellgp11,
        WS3a_CellGPF2: req.body.ws3a_cellgpf2,
        ws3b_hr10det: req.body.ws3b_hr10det,
        ws3b_hr10gpf: req.body.ws3b_hr10gpf,
        ws4_br10ed: req.body.ws4_br10ed,
  ...
  app.get("/produccionhoratarde/:fechainicial/:fechafinal/", function(
    req,
    res
  ) {
    let fechainicial = moment
  ...
  app.get("/produccionhoranoche/:fechainicial/:fechafinal/", function(
    req,
    res
  ) {
    let fechainicial = moment
      ...
      case "1":
        ...
        db.Goal.update(
          ...
          if (data) {
            return res
              .status(200)
              .send({ result: "redirect", url: "/production-goals" });
          } else {
    ...
    for (var i = 0; i < telefonos.length; i++) {
      ...
      client.messages
        .create({
          ...
          body:
            "The production report from last week:\n" +
            "HR10 Line: " +
            "*" +
            req.body.produccion_hr10 +
            "*" +
            ". Goal: " +
            req.body.meta_hr10 +
            ".\n" +
      ...
      [
        ...
        function(token, data, done) {
          ...
          var mailOptions = {
            ...
            text:
              "Estas recibiendo este mensaje porque tu (o alguien mas) ha pedido restablecer tu contraseña de tu cuenta.\n\n" +
    ...
    for (var i = 0; i < telefonos.length; i++) {
      ...
      client.messages
        .create({
          from: "whatsapp:" + process.env.TWILIO_PHONE, // From a valid Twilio number,
          body:
            "The price of Palladium is: " +
            req.body.palladium +
            " USD/oz. The original price was " +
            "960 USD/oz. The price of Rhodium is: " +
            req.body.rhodium +
            " USD/oz. The original price was " +
            "2,436 USD/oz.",
          to: "whatsapp:" + telefonos[i], // Text this number
    ...
    for (var i = 0; i < telefonos.length; i++) {
      ...
      client.messages
        .create({
          from: "whatsapp:" + process.env.TWILIO_PHONE, // From a valid Twilio number,
          body:
            "The price of Palladium is over the target of 1,750 USD/oz. The price of Palladium is: " +
            req.body.palladium +
            " USD/oz. The original price was 960 USD/oz. The price of Rhodium is: " +
            req.body.rhodium +
            " USD/oz. The original price was 2,436 USD/oz. ",
          to: "whatsapp:" + telefonos[i], // Text this number
        })
        .then(function(message) {
          console.log("Whatsapp:" + message.sid);
